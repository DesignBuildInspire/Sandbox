...
void sysexCallback(byte command, byte argc, byte *argv)
{
  ...
  switch (command) {
    ...
    case PING_READ: {
      ...
      byte responseArray[2];
      responseArray[1] = (((unsigned long)distance >> 7) & 0x7F);
      responseArray[0] = (((unsigned long)distance & 0x7F));

      // Firmata.sendSysex(PING_READ, 2, (byte *) &distance);
      Firmata.sendSysex(PING_READ, 2, responseArray);
